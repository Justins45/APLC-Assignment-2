...
class Student:
    ...
    def __str__(self):
        return (
            ...
            f"Semester: {self.current_semester or 'N/A'}, "
            f"Courses: {self.num_courses}, GPA: {self.gpa:.2f}"
        )
...
def main():
    ...
    while is_running:
        print(
            ...
            "3. Check a student's GPA\n"
            "4. Check a student's Course Count\n"
            "5. View a Student's Details\n"
            "6. List All Students\n"
            "7. Exit Application"
        )
